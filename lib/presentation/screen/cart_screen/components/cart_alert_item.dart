...
class CartAlertItem extends StatelessWidget {
  const CartAlertItem({
    Key? key,
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: TextFormField(
                          ...
                          onChanged: (val) {
                            cartScreenController.onChangeValue(val);
                          },
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: DefaultButton(
                    ...
                    onPressed: () {
                      if (cartScreenController.alertQty != "") {
                        Get.back();
                        cartScreenController.applyCartUpdate(productEntity);
                      }
                    },
